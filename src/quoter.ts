...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@baseswapfi/sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from './abis/Quoter.json'
import IQuoterV2 from './abis/QuoterV2.json'
