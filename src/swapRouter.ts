...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@baseswapfi/sdk-core'
...
import ISwapRouter from './abis/SwapRouter.json'
